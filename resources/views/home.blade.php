      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-right">
            <h2>{{$abouts->title}}</h2>
            <iframe  width="400" height="250" src="{{asset('frontend/assets/video/video1.mp4')}}" frameborder="0" allowfullscreen></iframe>
            {{-- <h3 style="text-align: justify">{{$abouts->short_dis}}</h3> --}}
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left">
            <p style="text-align: justify">{{$abouts->long_dis}}</p>
            <ul>
              <li><i class="ri-check-double-line"></i> 
                <a href="{{asset('frontend/assets/downloads/TAARIFA.pdf')}}" target="_blank">Instruction Form</a>
              </li>
        ...
        <div class="row no-gutters clients-wrap clearfix" data-aos="fade-up">
          ...
          <div class="col-lg-3 col-md-4 col-6">
            <div class="client-logo">
              <img src="{{$brand->brand_image}}" class="img-fluid" style="height: 100px; width:150px;" alt="">
              &nbsp; &nbsp; &nbsp;
