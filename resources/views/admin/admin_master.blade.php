...
<html lang="en" dir="ltr">
  ...
  <title>QuickBz - Admin Dashboard </title>
                ...
                <ul class="nav navbar-nav">                              
                  ...
                  <li class="dropdown user-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right"> 
                      ...
                      <li>
                        <a href="{{route('changePassword')}}"> <i class="mdi mdi-lock"></i> Change Password </a>
                      </li>               
        ...
        <div class="content-wrapper">
         ...
         @yield('admin')
            ...
            <div class="copyright bg-white">
              <p>
                &copy; <span id="copy-year">2019</span> Quick Business Registration | Developed by Samwel Mchomvu | From NOTTECH Lab
