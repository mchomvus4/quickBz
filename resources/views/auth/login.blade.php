...
<head>
  ...
  <body class="bg-light-gray" id="body">
        ...
        <div class="col-xl-5 col-lg-6 col-md-10">
          <div class="card">
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="{{url('/')}}">
                  <img src="{{asset('backend/assets/img/sleek-icon.png')}}" alt="">
                  <span class="brand-name">Quick Business</span>
                </a>
              </div>
            </div>
             @if(session('success'))
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; 2021 Copyright | Qiuck Bussiness Registration
          <a class="text-primary" href="" target="_blank">QuickBz</a>.
        </p>
      </div>
    </div>
</body>
